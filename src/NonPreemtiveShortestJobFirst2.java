...
class Process5 {
    ...
    public Process5(String id, int arrivalTime, int burstTime, String priority) {
        this.id = id;
...
public class NonPreemtiveShortestJobFirst2 extends JFrame {

    private DefaultTableModel tableModel;
    private JLabel resultLabel;

    public NonPreemtiveShortestJobFirst2() {
        setTitle("Non-Preemptive Shortes Job First");
        setSize(1000, 700);
...
""";
    ...
    private void calculateNonPreemptiveSJF(List<Process> processes) {
        int currentTime = 0;
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            NonPreemtiveShortestJobFirst2 gui = new NonPreemtiveShortestJobFirst2();
            gui.setVisible(true);
        });
    }
}