...
class Process4 {
    ...
    public Process4(String id, int arrivalTime, int burstTime, String priority) {
        this.id = id;
...
public class NonPreemtiveShortestjJobFirst extends JFrame {
...
""";
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            NonPreemtiveShortestjJobFirst gui = new NonPreemtiveShortestjJobFirst();
            gui.setVisible(true);
        });
    }
}
