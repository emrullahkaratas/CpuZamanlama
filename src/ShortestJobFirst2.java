...
class Process3 {
    ...
    public Process3(String id, int arrivalTime, int burstTime, String priority) {
        this.id = id;
...
public class ShortestJobFirst2 extends JFrame {

    private DefaultTableModel tableModel;
    private JLabel resultLabel;

    public ShortestJobFirst2() {
...
""";
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ShortestJobFirst2 gui = new ShortestJobFirst2();
            gui.setVisible(true);
        });
    }
}
