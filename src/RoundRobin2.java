...
class Process7 {
    ...
    public Process7(String id, int arrivalTime, int burstTime, String priority) {
        this.id = id;
        this.arrivalTime = arrivalTime;
        this.burstTime = burstTime;
        this.remainingBurst2 = burstTime;
        this.priority = priority;
    }
}

public class RoundRobin2 extends JFrame {
...
""";
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            RoundRobin2 gui = new RoundRobin2();
            gui.setVisible(true);
        });
    }
}