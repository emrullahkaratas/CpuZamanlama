...
class Process2 {
    ...
    public Process2(String id, int arrivalTime, int burstTime, String priority) {
        this.id = id;
...
public class ShortestJobFirst1 extends JFrame {

    private DefaultTableModel tableModel;
    private JLabel resultLabel;

    public ShortestJobFirst1() {
...
""";
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ShortestJobFirst1 gui = new ShortestJobFirst1();
            gui.setVisible(true);
        });
    }
}